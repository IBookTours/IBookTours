...
export const siteData: SiteContent = {
  ...
  events: {
    ...
    partners: [
      { id: 'airbnb', name: 'Airbnb', logo: 'https://logo.clearbit.com/airbnb.com', description: 'Vacation rentals and experiences' },
      { id: 'expedia', name: 'Expedia', logo: 'https://logo.clearbit.com/expedia.com', description: 'Travel booking platform' },
      { id: 'booking', name: 'Booking.com', logo: 'https://logo.clearbit.com/booking.com', description: 'Hotel reservations worldwide' },
      { id: 'tripadvisor', name: 'TripAdvisor', logo: 'https://logo.clearbit.com/tripadvisor.com', description: 'Travel reviews and booking' },
      { id: 'klm', name: 'KLM', logo: 'https://logo.clearbit.com/klm.com', description: 'Royal Dutch Airlines' },
    ],
  },
  ...
  blog: {
    ...
    posts: [
      ...
      {
        id: 'post6',
        title: 'The Ultimate Guide to Albania\'s UNESCO World Heritage Sites',
        excerpt: 'From ancient Butrint to the Ottoman wonders of Berat and Gjirokastër, explore the rich cultural heritage recognized by UNESCO.',
      ...
      {
        id: 'post7',
        title: 'Budget Travel in Albania: How to Explore on €50 a Day',
        excerpt: 'Albania is one of Europe\'s most affordable destinations. Here\'s your complete guide to traveling on a budget without missing out.',
        image: 'https://images.unsplash.com/photo-1565876427310-0695a4ff03b7?w=800&h=500&fit=crop&q=80',
  ...
  partners: [
    ...
    },
    {
      id: 'goglobal',
      name: 'GoGlobal',
      logo: 'https://logo.clearbit.com/goglobal.travel',
  ...
  vacationPackages: [
    ...
    },
    {
      ...
      destination: 'Durres Beach',
      location: 'Durres',
      departureCities: ['London', 'Paris', 'Frankfurt'],
      hotelName: 'Hotel Adriatik',
      hotelRating: 4,
      duration: '6 Days / 5 Nights',
      nights: 5,
      pricePerPerson: '€599',
    ...
    {
      id: 'kosovo-macedonia-explorer',
      destination: 'Kosovo & Macedonia',
      location: 'Pristina, Prizren, Ohrid',
      departureCities: ['Vienna', 'Istanbul', 'Milan'],
      hotelName: 'Swiss Diamond Hotel Pristina',
      hotelRating: 5,
    ...
    {
      id: 'southern-albania-heritage',
      destination: 'Southern Heritage',
      location: 'Gjirokaster & Permet',
      departureCities: ['Rome', 'Athens', 'Berlin'],
      hotelName: 'Kodra Hotel Gjirokaster',
      hotelRating: 4,
      duration: '6 Days / 5 Nights',
      nights: 5,
      pricePerPerson: '€729',
    ...
    {
      id: 'lake-ohrid-escape',
      destination: 'Lake Ohrid',
      location: 'Pogradec & Ohrid',
      departureCities: ['London', 'Vienna', 'Zurich'],
      hotelName: 'Enkelana Hotel',
      hotelRating: 4,
      duration: '5 Days / 4 Nights',
      nights: 4,
      pricePerPerson: '€549',
      ...
      highlights: [
        'Cross-border lake experience',
        'Lakefront hotel',
        'Breakfast daily',
        'Boat tour included',
        'St. Naum monastery visit',
      ],
      includesFlights: true,
      includesHotel: true,
      rating: 4.8,
    ...
    {
      id: 'theth-valbona-trek',
      destination: 'Alpine Trek',
      location: 'Theth & Valbona',
      departureCities: ['Munich', 'Milan', 'London'],
      hotelName: 'Mountain Guesthouses',
      hotelRating: 3,
      duration: '7 Days / 6 Nights',
      nights: 6,
      pricePerPerson: '€799',
      image: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=800&h=600&fit=crop&q=80',
      highlights: [
        'Iconic Peaks of the Balkans',
        'All meals included',
        'Professional mountain guide',
        'Ferry ride on Komani Lake',
    ...
    {
      id: 'wine-cuisine-tour',
      destination: 'Wine & Cuisine',
      location: 'Berat & Cobo Winery',
      departureCities: ['Paris', 'Rome', 'Vienna'],
      hotelName: 'Hotel Mangalemi Berat',
      hotelRating: 4,
      duration: '5 Days / 4 Nights',
      nights: 4,
      pricePerPerson: '€679',
      ...
      highlights: [
        'Culinary-focused adventure',
        'Boutique hotel in Berat',
    ...
    {
      id: 'shkodra-lake-discovery',
      destination: 'Shkodra Lake',
      location: 'Shkodra',
      departureCities: ['London', 'Berlin', 'Amsterdam'],
      hotelName: 'Hotel Colosseo Shkodra',
      hotelRating: 4,
