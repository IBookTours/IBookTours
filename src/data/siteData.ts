...
export const siteData: SiteContent = {
  ...
  events: {
    ...
    partners: [
      { id: 'airbnb', name: 'Airbnb', logo: '/logos/airbnb.svg', description: 'Vacation rentals and experiences' },
      { id: 'expedia', name: 'Expedia', logo: '/logos/expedia.svg', description: 'Travel booking platform' },
      { id: 'booking', name: 'Booking.com', logo: '/logos/booking.svg', description: 'Hotel reservations worldwide' },
      { id: 'tripadvisor', name: 'TripAdvisor', logo: '/logos/tripadvisor.svg', description: 'Travel reviews and booking' },
      { id: 'klm', name: 'KLM', logo: '/logos/klm.svg', description: 'Royal Dutch Airlines' },
    ],
  },
